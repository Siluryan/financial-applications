```{=html}
<section class="colophon" epub:type="frontmatter">
```

**Microsserviços financeiros — teoria e laboratório**

*Edição de laboratório · 2026*

Material educacional de **Guilherme Dias** (https://github.com/Siluryan). Objetivo: ensinar plataforma e cloud em contexto de pagamentos (*Pix*, limites, filas, mesh, observabilidade, conformidade). Biografia e contactos no final do volume (*Sobre o autor*).
